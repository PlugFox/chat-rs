...
extension type const MessageFlags(int value) implements int {
  ...
  static const List<MessageFlags> values = [edited, deleted, forwarded, pinned, silent, system, bot, reply];
  ...
  MessageFlags operator ^(MessageFlags other) => MessageFlags(value ^ other.value);
}
