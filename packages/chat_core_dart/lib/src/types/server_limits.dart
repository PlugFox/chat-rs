...
class ServerLimits {
  ...
  @override
  String toString() => 'ServerLimits(pingIntervalMs: $pingIntervalMs, pingTimeoutMs: $pingTimeoutMs, maxMessageSize: $maxMessageSize, maxExtraSize: $maxExtraSize, maxFrameSize: $maxFrameSize, messagesPerSec: $messagesPerSec, connectionsPerIp: $connectionsPerIp)';
}
