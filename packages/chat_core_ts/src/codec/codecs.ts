...
export function encodeLastMessagePreview(
  w: ProtocolWriter,
...
export function decodeLastMessagePreview(
  r: ProtocolReader,
): LastMessagePreview {
  return {
    id: r.readU32(),
...
export function encodeChatMemberEntry(
  w: ProtocolWriter,
  v: ChatMemberEntry,
): void {
  w.writeU32(v.userId);
...
export function encodeWelcomePayload(
  w: ProtocolWriter,
  v: WelcomePayload,
): void {
...
export function encodeSendMessagePayload(
  w: ProtocolWriter,
  v: SendMessagePayload,
): void {
  w.writeU32(v.chatId);
  w.writeU8(v.kind);
...
export function decodeSendMessagePayload(
  r: ProtocolReader,
): SendMessagePayload {
  return {
    chatId: r.readU32(),
...
export function encodeEditMessagePayload(
  w: ProtocolWriter,
  v: EditMessagePayload,
): void {
  w.writeU32(v.chatId);
...
export function decodeEditMessagePayload(
  r: ProtocolReader,
): EditMessagePayload {
  return {
    chatId: r.readU32(),
...
export function encodeDeleteMessagePayload(
  w: ProtocolWriter,
  v: DeleteMessagePayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.messageId);
}

export function decodeDeleteMessagePayload(
  r: ProtocolReader,
...
export function encodeReadReceiptPayload(
  w: ProtocolWriter,
  v: ReadReceiptPayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.messageId);
}

export function decodeReadReceiptPayload(
  r: ProtocolReader,
): ReadReceiptPayload {
  return {
    chatId: r.readU32(),
...
export function encodeGetPresencePayload(
  w: ProtocolWriter,
  v: GetPresencePayload,
): void {
  w.writeU16(v.userIds.length);
  for (const _v of v.userIds) w.writeU32(_v);
}

export function decodeGetPresencePayload(
  r: ProtocolReader,
): GetPresencePayload {
  return {
...
export function encodeSubscribePayload(
  w: ProtocolWriter,
  v: SubscribePayload,
): void {
...
export function encodeUnsubscribePayload(
  w: ProtocolWriter,
...
export function decodeUnsubscribePayload(
  r: ProtocolReader,
): UnsubscribePayload {
  return {
    channels: r.readVecString(),
...
export function encodeCreateChatPayload(
  w: ProtocolWriter,
  v: CreateChatPayload,
): void {
  w.writeU8(v.kind);
...
export function encodeUpdateChatPayload(
  w: ProtocolWriter,
  v: UpdateChatPayload,
): void {
  w.writeU32(v.chatId);
...
export function encodeDeleteChatPayload(
  w: ProtocolWriter,
  v: DeleteChatPayload,
): void {
  w.writeU32(v.chatId);
...
export function encodeGetChatInfoPayload(
  w: ProtocolWriter,
  v: GetChatInfoPayload,
): void {
  w.writeU32(v.chatId);
}

export function decodeGetChatInfoPayload(
  r: ProtocolReader,
): GetChatInfoPayload {
  return {
    chatId: r.readU32(),
...
export function encodeGetChatMembersPayload(
  w: ProtocolWriter,
  v: GetChatMembersPayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.cursor);
  w.writeU16(v.limit);
...
export function decodeGetChatMembersPayload(
  r: ProtocolReader,
...
export function encodeInviteMembersPayload(
  w: ProtocolWriter,
  v: InviteMembersPayload,
): void {
  w.writeU32(v.chatId);
  w.writeU16(v.userIds.length);
  for (const _v of v.userIds) w.writeU32(_v);
...
export function decodeInviteMembersPayload(
  r: ProtocolReader,
...
export function encodeLeaveChatPayload(
  w: ProtocolWriter,
  v: LeaveChatPayload,
): void {
  w.writeU32(v.chatId);
...
export function encodeUpdateMemberPayload(
  w: ProtocolWriter,
  v: UpdateMemberPayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.userId);
...
export function decodeUpdateMemberPayload(
  r: ProtocolReader,
): UpdateMemberPayload {
  return {
    chatId: r.readU32(),
...
export function encodeMessageDeletedPayload(
  w: ProtocolWriter,
  v: MessageDeletedPayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.messageId);
}

export function decodeMessageDeletedPayload(
  r: ProtocolReader,
...
export function encodeReceiptUpdatePayload(
  w: ProtocolWriter,
  v: ReceiptUpdatePayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.userId);
  w.writeU32(v.messageId);
...
export function decodeReceiptUpdatePayload(
  r: ProtocolReader,
...
export function encodeTypingUpdatePayload(
  w: ProtocolWriter,
  v: TypingUpdatePayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.userId);
  w.writeU16(v.expiresInMs);
...
export function decodeTypingUpdatePayload(
  r: ProtocolReader,
): TypingUpdatePayload {
  return {
    chatId: r.readU32(),
...
export function encodeMemberJoinedPayload(
  w: ProtocolWriter,
  v: MemberJoinedPayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.userId);
  w.writeU8(v.role);
...
export function decodeMemberJoinedPayload(
  r: ProtocolReader,
): MemberJoinedPayload {
  return {
    chatId: r.readU32(),
...
export function encodeMemberLeftPayload(
  w: ProtocolWriter,
  v: MemberLeftPayload,
): void {
  w.writeU32(v.chatId);
...
export function encodeChatDeletedPayload(
  w: ProtocolWriter,
  v: ChatDeletedPayload,
): void {
  w.writeU32(v.chatId);
}

export function decodeChatDeletedPayload(
  r: ProtocolReader,
): ChatDeletedPayload {
  return {
    chatId: r.readU32(),
...
export function encodeMemberUpdatedPayload(
  w: ProtocolWriter,
  v: MemberUpdatedPayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.userId);
  w.writeU8(v.role);
...
export function decodeMemberUpdatedPayload(
  r: ProtocolReader,
...
export function encodeAddReactionPayload(
  w: ProtocolWriter,
  v: AddReactionPayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.messageId);
  w.writeU32(v.packId);
...
export function decodeAddReactionPayload(
  r: ProtocolReader,
): AddReactionPayload {
  return {
    chatId: r.readU32(),
...
export function encodeRemoveReactionPayload(
  w: ProtocolWriter,
  v: RemoveReactionPayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.messageId);
  w.writeU32(v.packId);
...
export function decodeRemoveReactionPayload(
  r: ProtocolReader,
...
export function encodeReactionUpdatePayload(
  w: ProtocolWriter,
  v: ReactionUpdatePayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.messageId);
  w.writeU32(v.userId);
...
export function decodeReactionUpdatePayload(
  r: ProtocolReader,
...
export function encodePinMessagePayload(
  w: ProtocolWriter,
  v: PinMessagePayload,
): void {
  w.writeU32(v.chatId);
...
export function encodeUnpinMessagePayload(
  w: ProtocolWriter,
  v: UnpinMessagePayload,
): void {
  w.writeU32(v.chatId);
  w.writeU32(v.messageId);
}

export function decodeUnpinMessagePayload(
  r: ProtocolReader,
): UnpinMessagePayload {
  return {
    chatId: r.readU32(),
...
export function encodeRefreshTokenPayload(
  w: ProtocolWriter,
  v: RefreshTokenPayload,
): void {
  w.writeString(v.token);
}

export function decodeRefreshTokenPayload(
  r: ProtocolReader,
): RefreshTokenPayload {
  return {
    token: r.readString(),
...
export function encodeForwardMessagePayload(
  w: ProtocolWriter,
  v: ForwardMessagePayload,
): void {
...
export function decodeForwardMessagePayload(
  r: ProtocolReader,
...
export function encodeGetUserPayload(
  w: ProtocolWriter,
  v: GetUserPayload,
): void {
  w.writeU32(v.userId);
...
export function encodeGetUsersPayload(
  w: ProtocolWriter,
  v: GetUsersPayload,
): void {
  w.writeU16(v.userIds.length);
...
export function encodeUpdateProfilePayload(
  w: ProtocolWriter,
  v: UpdateProfilePayload,
): void {
...
export function decodeUpdateProfilePayload(
  r: ProtocolReader,
...
export function encodeBlockUserPayload(
  w: ProtocolWriter,
  v: BlockUserPayload,
): void {
  w.writeU32(v.userId);
...
export function encodeUnblockUserPayload(
  w: ProtocolWriter,
  v: UnblockUserPayload,
): void {
  w.writeU32(v.userId);
}

export function decodeUnblockUserPayload(
  r: ProtocolReader,
): UnblockUserPayload {
  return {
    userId: r.readU32(),
...
export function encodeGetBlockListPayload(
  w: ProtocolWriter,
  v: GetBlockListPayload,
): void {
  w.writeU32(v.cursor);
  w.writeU16(v.limit);
}

export function decodeGetBlockListPayload(
  r: ProtocolReader,
): GetBlockListPayload {
  return {
    cursor: r.readU32(),
...
export function encodeMuteChatPayload(
  w: ProtocolWriter,
  v: MuteChatPayload,
): void {
  w.writeU32(v.chatId);
...
export function encodeUnmuteChatPayload(
  w: ProtocolWriter,
  v: UnmuteChatPayload,
): void {
  w.writeU32(v.chatId);
...
export function encodeLoadChatsPayload(
  w: ProtocolWriter,
  v: LoadChatsPayload,
): void {
  switch (v.type) {
...
export function decodeLoadChatsPayload(r: ProtocolReader): LoadChatsPayload {
  ...
  switch (_d) {
    ...
    default:
      throw new CodecError(`unknown LoadChatsPayload discriminant: ${_d}`);
  }
}
...
export function decodeSearchScope(r: ProtocolReader): SearchScope {
  ...
  switch (_d) {
    ...
    default:
      throw new CodecError(`unknown SearchScope discriminant: ${_d}`);
  }
}

export function encodeLoadMessagesPayload(
  w: ProtocolWriter,
  v: LoadMessagesPayload,
): void {
  switch (v.type) {
    case "paginate":
      w.writeU32(v.chatId);
...
export function decodeLoadMessagesPayload(
  r: ProtocolReader,
): LoadMessagesPayload {
  const chatId = r.readU32();
  const _d = r.readU8();
  switch (_d) {
    ...
    default:
      throw new CodecError(`unknown LoadMessagesPayload mode: ${_d}`);
  }
}
...
export function decodeMemberAction(r: ProtocolReader): MemberAction {
  ...
  switch (_d) {
    ...
    case 3:
      return {
        type: "changeRole",
        chatRole: r.readEnum(r.readU8(), chatRoleFromValue, "ChatRole"),
      };
    case 4:
    ...
    case 5:
      return { type: "unban" };
    default:
      throw new CodecError(`unknown MemberAction discriminant: ${_d}`);
  }
}
