...
export function decodeFrameHeader(r: ProtocolReader): FrameHeader {
  ...
  if (kind === undefined)
    throw new CodecError(`unknown FrameKind: ${kindByte}`);
...
function framePayloadKind(p: FramePayload): FrameKind {
  switch (p.type) {
    case "hello":
      return 1 as FrameKind;
    case "welcome":
      return 2 as FrameKind;
    case "ping":
      return 3 as FrameKind;
    case "pong":
      return 4 as FrameKind;
    case "refreshToken":
      return 5 as FrameKind;
    case "sendMessage":
      return 16 as FrameKind;
    case "editMessage":
      return 17 as FrameKind;
    case "deleteMessage":
      return 18 as FrameKind;
    case "readReceipt":
      return 19 as FrameKind;
    case "typing":
      return 20 as FrameKind;
    case "getPresence":
      return 21 as FrameKind;
    case "loadChats":
      return 22 as FrameKind;
    case "search":
      return 23 as FrameKind;
    case "subscribe":
      return 24 as FrameKind;
    case "unsubscribe":
      return 25 as FrameKind;
    case "loadMessages":
      return 26 as FrameKind;
    case "addReaction":
      return 27 as FrameKind;
    case "removeReaction":
      return 28 as FrameKind;
    case "pinMessage":
      return 29 as FrameKind;
    case "unpinMessage":
      return 30 as FrameKind;
    case "forwardMessage":
      return 31 as FrameKind;
    case "messageNew":
      return 32 as FrameKind;
    case "messageEdited":
      return 33 as FrameKind;
    case "messageDeleted":
      return 34 as FrameKind;
    case "receiptUpdate":
      return 35 as FrameKind;
    case "typingUpdate":
      return 36 as FrameKind;
    case "memberJoined":
      return 37 as FrameKind;
    case "memberLeft":
      return 38 as FrameKind;
    case "presenceResult":
      return 39 as FrameKind;
    case "chatUpdated":
      return 40 as FrameKind;
    case "chatCreated":
      return 41 as FrameKind;
    case "reactionUpdate":
      return 42 as FrameKind;
    case "userUpdated":
      return 43 as FrameKind;
    case "chatDeleted":
      return 44 as FrameKind;
    case "memberUpdated":
      return 45 as FrameKind;
    case "ack":
      return 48 as FrameKind;
    case "error":
      return 49 as FrameKind;
    case "createChat":
      return 64 as FrameKind;
    case "updateChat":
      return 65 as FrameKind;
    case "deleteChat":
      return 66 as FrameKind;
    case "getChatInfo":
      return 67 as FrameKind;
    case "getChatMembers":
      return 68 as FrameKind;
    case "inviteMembers":
      return 69 as FrameKind;
    case "updateMember":
      return 70 as FrameKind;
    case "leaveChat":
      return 71 as FrameKind;
    case "muteChat":
      return 72 as FrameKind;
    case "unmuteChat":
      return 73 as FrameKind;
    case "getUser":
      return 80 as FrameKind;
    case "getUsers":
      return 81 as FrameKind;
    case "updateProfile":
      return 82 as FrameKind;
    case "blockUser":
      return 83 as FrameKind;
    case "unblockUser":
      return 84 as FrameKind;
    case "getBlockList":
      return 85 as FrameKind;
  }
}
...
export function encodeFrame(w: ProtocolWriter, frame: Frame): void {
  ...
  switch (frame.payload.type) {
    case "hello":
      encodeHelloPayload(w, frame.payload.data);
      break;
    case "welcome":
      encodeWelcomePayload(w, frame.payload.data);
      break;
    case "ping":
      break;
    case "pong":
      break;
    case "refreshToken":
      encodeRefreshTokenPayload(w, frame.payload.data);
      break;
    case "sendMessage":
      encodeSendMessagePayload(w, frame.payload.data);
      break;
    case "editMessage":
      encodeEditMessagePayload(w, frame.payload.data);
      break;
    case "deleteMessage":
      encodeDeleteMessagePayload(w, frame.payload.data);
      break;
    case "readReceipt":
      encodeReadReceiptPayload(w, frame.payload.data);
      break;
    case "typing":
      encodeTypingPayload(w, frame.payload.data);
      break;
    case "getPresence":
      encodeGetPresencePayload(w, frame.payload.data);
      break;
    case "loadChats":
      encodeLoadChatsPayload(w, frame.payload.data);
      break;
    case "search":
      encodeSearchPayload(w, frame.payload.data);
      break;
    case "subscribe":
      encodeSubscribePayload(w, frame.payload.data);
      break;
    case "unsubscribe":
      encodeUnsubscribePayload(w, frame.payload.data);
      break;
    case "loadMessages":
      encodeLoadMessagesPayload(w, frame.payload.data);
      break;
    case "addReaction":
      encodeAddReactionPayload(w, frame.payload.data);
      break;
    case "removeReaction":
      encodeRemoveReactionPayload(w, frame.payload.data);
      break;
    case "pinMessage":
      encodePinMessagePayload(w, frame.payload.data);
      break;
    case "unpinMessage":
      encodeUnpinMessagePayload(w, frame.payload.data);
      break;
    case "forwardMessage":
      encodeForwardMessagePayload(w, frame.payload.data);
      break;
    case "messageNew":
      encodeMessage(w, frame.payload.data);
      break;
    case "messageEdited":
      encodeMessage(w, frame.payload.data);
      break;
    case "messageDeleted":
      encodeMessageDeletedPayload(w, frame.payload.data);
      break;
    case "receiptUpdate":
      encodeReceiptUpdatePayload(w, frame.payload.data);
      break;
    case "typingUpdate":
      encodeTypingUpdatePayload(w, frame.payload.data);
      break;
    case "memberJoined":
      encodeMemberJoinedPayload(w, frame.payload.data);
      break;
    case "memberLeft":
      encodeMemberLeftPayload(w, frame.payload.data);
      break;
    case "presenceResult":
      w.writeU16(frame.payload.data.length);
      for (const _e of frame.payload.data) encodePresenceEntry(w, _e);
      break;
    case "chatUpdated":
      encodeChatEntry(w, frame.payload.data);
      break;
    case "chatCreated":
      encodeChatEntry(w, frame.payload.data);
      break;
    case "reactionUpdate":
      encodeReactionUpdatePayload(w, frame.payload.data);
      break;
    case "userUpdated":
      encodeUserEntry(w, frame.payload.data);
      break;
    case "chatDeleted":
      encodeChatDeletedPayload(w, frame.payload.data);
      break;
    case "memberUpdated":
      encodeMemberUpdatedPayload(w, frame.payload.data);
      break;
    case "ack":
      w.writeRawBytes(frame.payload.data);
      break;
    case "error":
      encodeErrorPayload(w, frame.payload.data);
      break;
    case "createChat":
      encodeCreateChatPayload(w, frame.payload.data);
      break;
    case "updateChat":
      encodeUpdateChatPayload(w, frame.payload.data);
      break;
    case "deleteChat":
      encodeDeleteChatPayload(w, frame.payload.data);
      break;
    case "getChatInfo":
      encodeGetChatInfoPayload(w, frame.payload.data);
      break;
    case "getChatMembers":
      encodeGetChatMembersPayload(w, frame.payload.data);
      break;
    case "inviteMembers":
      encodeInviteMembersPayload(w, frame.payload.data);
      break;
    case "updateMember":
      encodeUpdateMemberPayload(w, frame.payload.data);
      break;
    case "leaveChat":
      encodeLeaveChatPayload(w, frame.payload.data);
      break;
    case "muteChat":
      encodeMuteChatPayload(w, frame.payload.data);
      break;
    case "unmuteChat":
      encodeUnmuteChatPayload(w, frame.payload.data);
      break;
    case "getUser":
      encodeGetUserPayload(w, frame.payload.data);
      break;
    case "getUsers":
      encodeGetUsersPayload(w, frame.payload.data);
      break;
    case "updateProfile":
      encodeUpdateProfilePayload(w, frame.payload.data);
      break;
    case "blockUser":
      encodeBlockUserPayload(w, frame.payload.data);
      break;
    case "unblockUser":
      encodeUnblockUserPayload(w, frame.payload.data);
      break;
    case "getBlockList":
      encodeGetBlockListPayload(w, frame.payload.data);
      break;
  }
}
...
export function decodeFrame(r: ProtocolReader): Frame {
  ...
  switch (header.kind) {
    case 1:
      payload = { type: "hello", data: decodeHelloPayload(r) };
      break;
    case 2:
      payload = { type: "welcome", data: decodeWelcomePayload(r) };
      break;
    case 3:
      payload = { type: "ping" };
      break;
    case 4:
      ...
      break;
    case 5:
      payload = { type: "refreshToken", data: decodeRefreshTokenPayload(r) };
      break;
    case 16:
      payload = { type: "sendMessage", data: decodeSendMessagePayload(r) };
      break;
    case 17:
      payload = { type: "editMessage", data: decodeEditMessagePayload(r) };
      break;
    case 18:
      payload = { type: "deleteMessage", data: decodeDeleteMessagePayload(r) };
      break;
    case 19:
      payload = { type: "readReceipt", data: decodeReadReceiptPayload(r) };
      break;
    case 20:
      payload = { type: "typing", data: decodeTypingPayload(r) };
      break;
    case 21:
      payload = { type: "getPresence", data: decodeGetPresencePayload(r) };
      break;
    case 22:
      payload = { type: "loadChats", data: decodeLoadChatsPayload(r) };
      break;
    case 23:
      payload = { type: "search", data: decodeSearchPayload(r) };
      break;
    case 24:
      payload = { type: "subscribe", data: decodeSubscribePayload(r) };
      break;
    case 25:
      payload = { type: "unsubscribe", data: decodeUnsubscribePayload(r) };
      break;
    case 26:
      payload = { type: "loadMessages", data: decodeLoadMessagesPayload(r) };
      break;
    case 27:
      payload = { type: "addReaction", data: decodeAddReactionPayload(r) };
      break;
    case 28:
      payload = {
        type: "removeReaction",
        data: decodeRemoveReactionPayload(r),
      };
      break;
    case 29:
      payload = { type: "pinMessage", data: decodePinMessagePayload(r) };
      break;
    case 30:
      payload = { type: "unpinMessage", data: decodeUnpinMessagePayload(r) };
      break;
    case 31:
      payload = {
        type: "forwardMessage",
        data: decodeForwardMessagePayload(r),
      };
      break;
    case 32:
      payload = { type: "messageNew", data: decodeMessage(r) };
      break;
    case 33:
      payload = { type: "messageEdited", data: decodeMessage(r) };
      break;
    case 34:
      payload = {
        type: "messageDeleted",
        data: decodeMessageDeletedPayload(r),
      };
      break;
    case 35:
      payload = { type: "receiptUpdate", data: decodeReceiptUpdatePayload(r) };
      break;
    case 36:
      payload = { type: "typingUpdate", data: decodeTypingUpdatePayload(r) };
      break;
    case 37:
      payload = { type: "memberJoined", data: decodeMemberJoinedPayload(r) };
      break;
    case 38:
      payload = { type: "memberLeft", data: decodeMemberLeftPayload(r) };
      break;
    case 39:
      payload = {
        type: "presenceResult",
        data: r.readArray(r.readU16(), () => decodePresenceEntry(r)),
      };
      break;
    case 40:
      payload = { type: "chatUpdated", data: decodeChatEntry(r) };
      break;
    case 41:
      payload = { type: "chatCreated", data: decodeChatEntry(r) };
      break;
    case 42:
      payload = {
        type: "reactionUpdate",
        data: decodeReactionUpdatePayload(r),
      };
      break;
    case 43:
      payload = { type: "userUpdated", data: decodeUserEntry(r) };
      break;
    case 44:
      payload = { type: "chatDeleted", data: decodeChatDeletedPayload(r) };
      break;
    case 45:
      payload = { type: "memberUpdated", data: decodeMemberUpdatedPayload(r) };
      break;
    case 48:
      payload = {
        type: "ack",
        data: r.remaining > 0 ? r.readBytes(r.remaining) : new Uint8Array(0),
      };
      break;
    case 49:
      payload = { type: "error", data: decodeErrorPayload(r) };
      break;
    case 64:
      payload = { type: "createChat", data: decodeCreateChatPayload(r) };
      break;
    case 65:
      payload = { type: "updateChat", data: decodeUpdateChatPayload(r) };
      break;
    case 66:
      payload = { type: "deleteChat", data: decodeDeleteChatPayload(r) };
      break;
    case 67:
      payload = { type: "getChatInfo", data: decodeGetChatInfoPayload(r) };
      break;
    case 68:
      payload = {
        type: "getChatMembers",
        data: decodeGetChatMembersPayload(r),
      };
      break;
    case 69:
      payload = { type: "inviteMembers", data: decodeInviteMembersPayload(r) };
      break;
    case 70:
      payload = { type: "updateMember", data: decodeUpdateMemberPayload(r) };
      break;
    case 71:
      payload = { type: "leaveChat", data: decodeLeaveChatPayload(r) };
      break;
    case 72:
      payload = { type: "muteChat", data: decodeMuteChatPayload(r) };
      break;
    case 73:
      payload = { type: "unmuteChat", data: decodeUnmuteChatPayload(r) };
      break;
    case 80:
      payload = { type: "getUser", data: decodeGetUserPayload(r) };
      break;
    case 81:
      payload = { type: "getUsers", data: decodeGetUsersPayload(r) };
      break;
    case 82:
      payload = { type: "updateProfile", data: decodeUpdateProfilePayload(r) };
      break;
    case 83:
      payload = { type: "blockUser", data: decodeBlockUserPayload(r) };
      break;
    case 84:
      payload = { type: "unblockUser", data: decodeUnblockUserPayload(r) };
      break;
    case 85:
      payload = { type: "getBlockList", data: decodeGetBlockListPayload(r) };
      break;
    default:
      throw new CodecError(`unhandled FrameKind: ${header.kind}`);
  }
