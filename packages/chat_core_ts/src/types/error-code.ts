...
export function errorCodeFromValue(value: number): ErrorCode | undefined {
  switch (value) {
    case 1000: return ErrorCode.Unauthorized;
    case 1001: return ErrorCode.TokenExpired;
    case 1002: return ErrorCode.Forbidden;
    case 1003: return ErrorCode.SessionRevoked;
    case 1004: return ErrorCode.UnsupportedVersion;
    case 2000: return ErrorCode.ChatNotFound;
    case 2001: return ErrorCode.ChatAlreadyExists;
    case 2002: return ErrorCode.NotChatMember;
    case 2003: return ErrorCode.ChatFull;
    case 3000: return ErrorCode.MessageNotFound;
    case 3001: return ErrorCode.MessageTooLarge;
    case 3002: return ErrorCode.ExtraTooLarge;
    case 3003: return ErrorCode.RateLimited;
    case 3004: return ErrorCode.ContentFiltered;
    case 4000: return ErrorCode.FileTooLarge;
    case 4001: return ErrorCode.UnsupportedMediaType;
    case 4002: return ErrorCode.UploadFailed;
    case 5000: return ErrorCode.InternalError;
    case 5001: return ErrorCode.ServiceUnavailable;
    case 5002: return ErrorCode.DatabaseError;
    case 9000: return ErrorCode.MalformedFrame;
    case 9001: return ErrorCode.UnknownCommand;
    case 9002: return ErrorCode.FrameTooLarge;
...
export function errorCodeSlug(code: ErrorCode): string {
  switch (code) {
    ...
    case ErrorCode.SessionRevoked: return 'session_revoked';
    case ErrorCode.UnsupportedVersion: return 'unsupported_version';
    case ErrorCode.ChatNotFound: return 'chat_not_found';
    case ErrorCode.ChatAlreadyExists: return 'chat_already_exists';
    case ErrorCode.NotChatMember: return 'not_chat_member';
    case ErrorCode.ChatFull: return 'chat_full';
    case ErrorCode.MessageNotFound: return 'message_not_found';
    case ErrorCode.MessageTooLarge: return 'message_too_large';
    case ErrorCode.ExtraTooLarge: return 'extra_too_large';
    case ErrorCode.RateLimited: return 'rate_limited';
    case ErrorCode.ContentFiltered: return 'content_filtered';
    case ErrorCode.FileTooLarge: return 'file_too_large';
    case ErrorCode.UnsupportedMediaType: return 'unsupported_media_type';
    case ErrorCode.UploadFailed: return 'upload_failed';
